...
## Phase 1 — Boundaries only (low risk) — **done**
...
## Phase 2 — Extract pure builders — **done**
...
`CalendarGenerationService.buildCalendarMonths(...)` owns consecutive and syncScroll-gapped month arrays; the Host only orchestrates.
