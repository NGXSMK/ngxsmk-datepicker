export const translations = {
    en: {
        common: {
            ...
            installToday: 'Join thousands of developers using the most accessible and Signal-powered Angular DatePicker. Install today and boost your performance.',
        ...
        home: {
            ...
            seoText: 'NGXSMK is the most optimized Angular DatePicker components library. Designed for ultra-fast performance and seamless Signal integration, it scales from simple forms to complex enterprise dashboards.',
        ...
        installation: {
            ...
            altLead: 'Support for pnpm, Bun, and direct Git installation paths. Follow the best practices for bundle optimization.',
            ...
            zonelessLead: 'NGXSMK is the world\'s first native Zoneless Angular DatePicker. No extra config needed for zone.js-free apps.'
        },
        examples: {
        ...
        integrations: {
            ...
            webComponentsLead: 'Since ngxsmk-datepicker is a highly isolated Angular library without heavy dependencies, it can be compiled into Custom Web Components using Angular Elements. This allows you to use exactly the same beautiful datepicker in React, Vue, Svelte, or Vanilla JavaScript.',
    ...
    de: {
        ...
        advanced: {
            ...
            signalFormsTitle: 'Signal Forms Integration (Angular 21+)',
            signalFormsLead: 'Integrieren Sie sich nahtlos in die neuesten Angular Signal-basierten Formulare. Minimaler Boilerplate, maximale Reaktivität.',
            ...
            holidaysLead: 'Stellen Sie einen HolidayProvider bereit, um bestimmte Daten automatisch mit Bezeichnungen hervorzuheben.',
            holidayLabels: {
                newYear: 'Neujahr',
        ...
        integrations: {
            ...
            materialTitle: 'Angular Material',
            materialLead: 'Die Bibliothek bietet integrierte Unterstützung für MatFormField. Sie können den Datepicker in einem standardmäßigen Material-Feld mit schwebenden Labels, Hinweisen und Fehlerzuständen verwenden.',
            materialLabel: 'Datum wählen',
            ionicTitle: 'Ionic Framework',
            ionicLead: 'Für Ionic-Anwendungen fühlt sich der Datepicker direkt wie zu Hause an. Er funktioniert nahtlos in ion-item und erbt automatisch die Ionic-CSS-Variablen Ihrer Anwendung (wie --ion-color-primary für den aktiven Zustand). Wir empfehlen dringend, [useNativePicker]="true" zu aktivieren, um die nativen OS-Geräterad-Picker auf Mobilgeräten für das beste Benutzererlebnis zu nutzen.',
            ionicLabel: 'Datum',
            proTip: 'Profi-Tipp',
            ...
            webComponentsTitle: 'React, Vue & Vanilla JS',
            webComponentsLead: 'Da ngxsmk-datepicker eine hoch isolierte Angular-Bibliothek ohne schwere Abhängigkeiten ist, kann sie mit Angular Elements in Custom Web Components kompiliert werden. Dies ermöglicht es Ihnen, genau denselben schönen Datepicker in React, Vue, Svelte oder Vanilla JavaScript zu verwenden.',
    ...
    es: {
        ...
        advanced: {
            ...
            signalFormsLead: 'Integración perfecta con los últimos formularios basados en Signals de Angular. Mínimo código repetitivo, máxima reactividad.',
            keyboardTitle: 'Atajos de Teclado',
            keyboardLead: 'Soporte completo de accesibilidad (A11y). Navegue a través de fechas y años puramente con su teclado.',
            shortcuts: {
        ...
        integrations: {
            ...
            webComponentsLead: 'Dado que ngxsmk-datepicker es una biblioteca de Angular altamente aislada sin dependencias pesadas, se puede compilar en Custom Web Components utilizando Angular Elements. Esto le permite usar exactamente el mismo hermoso selector de fechas en React, Vue, Svelte o Vanilla JavaScript.',
    ...
    sv: {
        ...
        advanced: {
            ...
            signalFormsTitle: 'Signal Forms-integration (Angular 21+)',
            signalFormsLead: 'Integrera sömlöst med de senaste Angular Signal-baserade formulären. Minimal boilerplate, maximal reaktivitet.',
        ...
        integrations: {
            ...
            webComponentsTitle: 'React, Vue & Vanilla JS',
            webComponentsLead: 'Eftersom ngxsmk-datepicker är ett högisolerat Angular-bibliotek utan tunga beroenden, kan det kompileras till Custom Web Components med hjälp av Angular Elements. Detta gör att du kan använda exakt samma vackra datumväljare i React, Vue, Svelte eller Vanilla JavaScript.',
    ...
    ko: {
        ...
        advanced: {
            ...
            signalFormsLead: '최신 Angular Signal 기반 폼과 완벽하게 통합됩니다. 최소한의 상용구로 최대의 반응성을 제공합니다.',
    ...
    ja: {
        ...
        advanced: {
            ...
            signalFormsLead: '最新の Angular Signal ベースのフォームとシームレスに統合。最小限のボイラープレートで最大限の反応性を実現。',
    ...
    fr: {
        ...
        advanced: {
            ...
            signalFormsLead: 'Intégrez de manière fluide les derniers formulaires basés sur les Signals d\'Angular. Moins de code, réactivité maximale.',
            ...
            holidaysLead: 'Fournissez un HolidayProvider pour mettre automatiquement en évidence certaines dates avec des étiquettes.',
            holidayLabels: {
                newYear: 'Nouvel An',
        ...
        integrations: {
            ...
            ionicLead: 'Pour les applications Ionic, le sélecteur de date se sent comme chez lui. Il fonctionne sans problème à l\'intérieur de ion-item et hérite automatiquement des variables CSS Ionic de votre application (comme --ion-color-primary pour l\'état actif). Nous recommandons vivement d\'activer [useNativePicker]="true" pour exploiter les sélecteurs natifs sur mobile pour une meilleure expérience.',
            ionicLabel: 'Date',
            ...
            webComponentsTitle: 'React, Vue & Vanilla JS',
            webComponentsLead: 'Comme ngxsmk-datepicker est une bibliothèque Angular hautement isolée sans dépendances lourdes, elle peut être compilée en Web Components personnalisés à l\'aide d\'Angular Elements. Cela vous permet d\'utiliser exactement le même magnifique sélecteur de date dans React, Vue, Svelte ou Vanilla JavaScript.',
