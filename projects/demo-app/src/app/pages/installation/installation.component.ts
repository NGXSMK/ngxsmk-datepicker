  ...
  template: `
    <div class="animate-fade-in">
      ...
      <div class="card bg-code">
        <pre><code class="text-main">npm install ngxsmk-datepicker@2.1.6</code></pre>
      </div>
      ...
      <div class="card bg-code">
        <pre><code class="text-main">yarn add ngxsmk-datepicker@2.1.6
pnpm add ngxsmk-datepicker@2.1.6
bun add ngxsmk-datepicker@2.1.6</code></pre>
      </div>
      <p>
