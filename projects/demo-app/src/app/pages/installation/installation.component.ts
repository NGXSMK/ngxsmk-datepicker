  ...
  template: `
    <div class="animate-fade-in">
      ...
      <div class="code-window">
        ...
        <pre><code class="text-main"><span class="token-function">npm install</span> ngxsmk-datepicker@<span class="token-number">2.2.12</span></code></pre>
      </div>
      ...
      <div class="code-window">
        ...
        <pre><code class="text-main"><span class="token-function">yarn add</span> ngxsmk-datepicker@<span class="token-number">2.2.12</span>
<span class="token-function">pnpm add</span> ngxsmk-datepicker@<span class="token-number">2.2.12</span>
<span class="token-function">bun add</span> ngxsmk-datepicker@<span class="token-number">2.2.12</span></code></pre>
      </div>
      <p>
        <a
