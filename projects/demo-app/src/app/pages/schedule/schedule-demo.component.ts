...
import { ScheduleEditorComponent, ScheduleItem, ScheduleChangeEvent, ScheduleFieldsConfig } from 'ngxsmk-datepicker';
...
@Component({
  ...
  template: `
    <div class="animate-fade-in schedule-demo-page">
      ...
      <div class="page-header">
        ...
        <p class="text-lg">
          A fully-customizable schedule panel. Add, edit, drag-and-drop, filter, and export items — every unit is
          overridable.
        </p>
      </div>
      ...
      <section class="demo-section">
        <div class="demo-section__header">
          ...
          <p>
            All features enabled: drag-and-drop reorder, inline add/edit form, search, sort, tag/category filters,
            conflict detection, and JSON/CSV/ICS export.
          </p>
        </div>
      ...
      <section class="demo-section">
        <div class="demo-section__header">
          ...
          <p>
            Only title + date fields visible. Color, icon, tags, notes, and all extra controls hidden via
            <code>scheduleFields</code>.
          </p>
        </div>
      ...
      <section class="demo-section">
        <div class="demo-section__header">
          ...
          <p>
            The default row is replaced entirely via <code>[scheduleRowTemplate]</code>. Your
            <code>TemplateRef</code> receives <code>{{ '{' }} $implicit: ScheduleItem {{ '}' }}</code
            >.
          </p>
        </div>
      ...
      <section class="demo-section">
        <div class="demo-section__header">
          ...
          <p>
            The <code>[onBeforeDelete]</code> hook intercepts the delete action. Return <code>false</code> to cancel.
            Here we show a native <code>confirm()</code> dialog.
          </p>
        </div>
      ...
      <section class="demo-section">
        <div class="demo-section__header">
          ...
          <p>
            The <code>[validateScheduleItem]</code> hook runs after built-in validation. Here titles must start with a
            capital letter.
          </p>
        </div>
      ...
      <section class="demo-section">
        ...
        <div
          class="demo-editor-wrap demo-editor-wrap--fullpage"
          style="height: 520px; border: 1px solid var(--color-border); border-radius: 16px; overflow: hidden;"
        >
          <smk-schedule-editor
            [fullPage]="true"
            ...
            <tbody>
              @for (row of apiRows; track row.input) {
                <tr>
                  ...
                  <td>
                    <code class="default">{{ row.default }}</code>
                  </td>
                  <td>{{ row.desc }}</td>
                </tr>
              }
  ...
  styles: [
    `
      ...
      .demo-log__entry--Added .demo-log__badge {
        background: rgba(34, 197, 94, 0.15);
        color: #22c55e;
      }
      .demo-log__entry--Editing .demo-log__badge {
        background: rgba(59, 130, 246, 0.15);
        color: #3b82f6;
      }
      .demo-log__entry--Deleted .demo-log__badge {
        background: rgba(239, 68, 68, 0.15);
        color: #ef4444;
      }
      .demo-log__entry--Duplicated .demo-log__badge {
        background: rgba(168, 85, 247, 0.15);
        color: #a855f7;
      }
      .demo-log__entry--applied .demo-log__badge {
...
export class ScheduleDemoComponent {
  ...
  logEvent(type: string, item: ScheduleItem) {
    ...
    this.eventLog.update((log) => [{ type, msg: `"${item.title}"`, time: now }, ...log.slice(0, 19)]);
  }
...
/>`;
  ...
  readonly apiRows = [
    ...
    { input: 'scheduleAddLabel', type: 'string', default: '"Add Item"', desc: 'Add button label' },
    {
      ...
      type: 'ScheduleFieldsConfig',
      default: 'all on',
      desc: 'Show/hide each form field individually',
    },
    {
      input: 'scheduleFormTemplates',
      type: 'ScheduleFormTemplates',
      default: 'null',
      desc: 'TemplateRef overrides for each form field',
    },
    {
      input: 'scheduleColorPresets',
      type: '(ScheduleColor|string)[]',
      default: '10 presets',
      desc: 'Color swatches in the color picker',
    },
    ...
    {
      input: 'scheduleBadgeTemplate',
      type: 'TemplateRef',
      default: 'null',
      desc: 'Replace only the date/duration badge',
    },
    { input: 'scheduleActionsTemplate', type: 'TemplateRef', default: 'null', desc: 'Replace the action button group' },
    {
      input: 'scheduleEmptyTemplate',
      type: 'TemplateRef',
      default: 'null',
      desc: 'Replace the empty-state placeholder',
    },
    ...
    {
      input: 'onBeforeReorder',
      type: '(from,to,items) => boolean',
      default: 'null',
      desc: 'Return false to cancel drag-drop',
    },
    {
      input: 'validateScheduleItem',
      type: '(item, all) => string|null',
      default: 'null',
      desc: 'Custom per-item validation',
    },
    ...
    { input: 'formatItemDuration', type: '(item) => string', default: 'null', desc: 'Custom duration label formatter' },
    {
      ...
      type: 'EventEmitter<ScheduleChangeEvent>',
      default: '—',
      desc: 'Fires on every mutation',
    },
