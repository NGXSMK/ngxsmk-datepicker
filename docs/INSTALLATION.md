...
| Method | Command |
|--------|--------|
| **npm** | `npm install ngxsmk-datepicker@2.4.0` |
...
```bash
npm install github:NGXSMK/ngxsmk-datepicker#v2.4.0
# or
yarn add github:NGXSMK/ngxsmk-datepicker#v2.4.0
...
- **unpkg:** `https://unpkg.com/ngxsmk-datepicker@2.4.0/fesm2022/ngxsmk-datepicker.mjs`
- **jsDelivr:** `https://cdn.jsdelivr.net/npm/ngxsmk-datepicker@2.4.0/fesm2022/ngxsmk-datepicker.mjs`
...
```bash
npm install https://github.com/NGXSMK/ngxsmk-datepicker/releases/download/v2.4.0/ngxsmk-datepicker-2.4.0.tgz
```
