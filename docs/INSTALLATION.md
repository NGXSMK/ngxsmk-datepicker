...
All of these resolve the package from the npm registry. Use the same version (e.g. `3.0.5`) or `@latest`.

| Method | Command |
|--------|--------|
| **npm** | `npm install ngxsmk-datepicker@3.0.5` |
...
- **unpkg:** `https://unpkg.com/ngxsmk-datepicker@3.0.5/fesm2022/ngxsmk-datepicker.mjs`
- **jsDelivr:** `https://cdn.jsdelivr.net/npm/ngxsmk-datepicker@3.0.5/fesm2022/ngxsmk-datepicker.mjs`
...
```bash
npm install https://github.com/NGXSMK/ngxsmk-datepicker/releases/download/v3.0.5/ngxsmk-datepicker-3.0.5.tgz
```
