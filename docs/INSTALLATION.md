...
| Method | Command |
|--------|--------|
| **npm** | `npm install ngxsmk-datepicker@2.3.2` |
...
```bash
npm install github:NGXSMK/ngxsmk-datepicker#v2.3.2
# or
yarn add github:NGXSMK/ngxsmk-datepicker#v2.3.2
pnpm add github:NGXSMK/ngxsmk-datepicker#v2.3.2
```
...
- **unpkg:** `https://unpkg.com/ngxsmk-datepicker@2.3.2/fesm2022/ngxsmk-datepicker.mjs`
- **jsDelivr:** `https://cdn.jsdelivr.net/npm/ngxsmk-datepicker@2.3.2/fesm2022/ngxsmk-datepicker.mjs`
...
```bash
npm install https://github.com/NGXSMK/ngxsmk-datepicker/releases/download/v2.3.2/ngxsmk-datepicker-2.3.2.tgz
```
