import {
  ...
  parseDateSchema,
  calculateDateRangeSchema,
  convertTimezoneSchema,
  getHolidaysSchema,
  validateDateSelectionSchema,
...
export const TOOLS_METADATA: ToolDefinition[] = [
  {
    name: 'parse_date',
    description:
  ...
  },
  {
    ...
    description:
      'Converts date and time strings across international IANA timezones with DST indicator and offset difference.',
    parameters: {
      type: 'object',
      properties: {
        date: {
  ...
  },
  {
    name: 'get_holidays',
    description:
      'Retrieves public and national holidays for a given year and country code (e.g. US, GB, DE, FR, LK).',
    parameters: {
      type: 'object',
      properties: {
        year: {
  ...
  },
  {
    ...
    description:
      'Validates a date or date range against constraints like minDate, maxDate, disabled dates list, and weekends.',
    parameters: {
      type: 'object',
      properties: {
        date: {
