...
import { z } from 'zod';
import { handleParseDate, handleCalculateDateRange, handleConvertTimezone, handleGetHolidays, handleValidateDateSelection, } from './tools/date-tools.js';
...
server.registerTool('calculate_date_range', {
...
// Tool: get_holidays
server.registerTool('get_holidays', {
...
server.registerTool('validate_date_selection', {
...
// Resources
server.registerResource('api_docs', API_DOCS_RESOURCE.uri, {
...
server.registerResource('timezones', TIMEZONES_RESOURCE.uri, {
...
// Prompts
server.registerPrompt('schedule_meeting', {
...
server.registerPrompt('plan_time_off', {
...
import { formatOpenAiTools, formatGeminiTools, formatClaudeTools, executeTool, TOOLS_METADATA, } from './adapters/llm-adapters.js';
export { formatOpenAiTools, formatGeminiTools, formatClaudeTools, executeTool, TOOLS_METADATA, };
