 ...
 */
export function handleParseDate(params) {
 ...
 */
export function handleCalculateDateRange(params) {
    const zone = params.timezone || 'UTC';
 ...
 */
export function handleConvertTimezone(params) {
 ...
 */
export function handleGetHolidays(params) {
 ...
 */
export function handleValidateDateSelection(params) {
    const errors = [];
    const blockedSet = new Set(params.disabledDates || []);
    function validateSingle(isoStr, label) {
